...
const STATS = [
  { label: '支持字段', value: '11+', icon: 'M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z', color: 'from-blue-500 to-cyan-500' },
  { label: '模板记忆', value: '∞', icon: 'M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4', color: 'from-indigo-500 to-purple-500' },
        ...
        <div className="space-y-6 stagger-children">
          ...
          {savedTemplates > 0 && (
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-100 rounded-xl p-4 flex items-center gap-3">
              ...
              <p className="text-sm text-blue-700">已记忆 <span className="font-semibold">{savedTemplates}</span> 个模板映射规则，上传相同结构文件将自动识别</p>
            </div>
          )}
      ...
      {step === 'parsing' && (
        <div className="bg-white rounded-2xl border border-gray-100 p-8 shadow-sm animate-scaleIn">
          <div className="flex items-center gap-4 mb-6">
            <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-blue-500 to-indigo-500 flex items-center justify-center shadow-md animate-float">
