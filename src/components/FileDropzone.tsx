  ...
  return (
    <div
      ...
      className={`
        ...
        ${dragging 
          ? 'border-[#227446] bg-[#227446]/10/80 scale-[1.01]' 
          : 'border-gray-200 bg-gradient-to-b from-gray-50/50 to-white hover:border-[#227446]/40 hover:bg-[#227446]/10/30'}
    ...
    >
      ...
      <div className={`w-16 h-16 rounded-lg flex items-center justify-center mb-4 transition-all duration-300 ${
        dragging ? 'bg-[#227446]/20 scale-110' : 'bg-gray-100'
      }`}>
        <svg className={`w-8 h-8 transition-colors duration-300 ${
          dragging ? 'text-[#227446]' : 'text-gray-400'
      ...
      <p className="text-slate-600 text-base mb-1">
        拖拽 Excel 文件到此处，或<span className="text-[#227446] font-semibold">点击选择文件</span>
      </p>
