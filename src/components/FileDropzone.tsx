  ...
  return (
    <div
      ...
      className={`
        ...
        ${dragging 
          ...
          : 'border-gray-200 bg-gradient-to-b from-gray-50/50 to-white hover:border-[#2563EB]/40 hover:bg-[#2563EB]/10'}
    ...
    >
      ...
      <div className={`w-16 h-16 rounded-lg flex items-center justify-center mb-4 transition-all duration-300 ${
        dragging ? 'bg-[#2563EB]/20 scale-110' : 'bg-gray-100'
      }`}>
        <svg className={`w-8 h-8 transition-colors duration-300 ${
          dragging ? 'text-[#2563EB]' : 'text-gray-400'
      ...
      <p className="text-slate-600 text-base mb-1">
        拖拽 Excel 文件到此处，或<span className="text-[#2563EB] font-semibold">点击选择文件</span>
      </p>
