...
export const FIELD_DEFS: FieldDef[] = [
  {
    ...
    label: '外部编码',
    required: false,
    aliases: ['外部编码', '外部订单号', 'ref code', 'refcode', '客户单号', '外部单号', '客户编码', '订单编号', '订单号'],
  },
  {
    key: 'sender_name',
    label: '发件人姓名',
    required: true,
    aliases: ['发件人姓名', '发货人', 'sender', '发件人', '寄件人', '寄方姓名', '寄件方', 'sender name'],
  },
  {
    key: 'sender_phone',
    label: '发件人电话',
    required: true,
    aliases: ['发件人电话', '发货电话', 'sender tel', '发件电话', '寄件电话', '寄方电话', 'sender phone', '发件人手机'],
  },
  {
    key: 'sender_address',
    label: '发件人地址',
    required: true,
    aliases: ['发件人地址', '发货地址', 'sender address', '发件地址', '寄件地址', '寄方地址'],
  },
  {
    key: 'receiver_name',
    label: '收件人姓名',
    required: true,
    aliases: ['收件人姓名', '收货人', 'receiver', '收件人', '收方', '收方姓名', '收货方', 'receiver name'],
  },
  {
    key: 'receiver_phone',
    label: '收件人电话',
    required: true,
    aliases: ['收件人电话', '收货电话', 'receiver tel', '收件电话', '收方电话', '收货方电话', 'receiver phone'],
  },
  {
    key: 'receiver_address',
    label: '收件人地址',
    required: true,
    aliases: ['收件人地址', '收货地址', 'receiver address', '收件地址', '收方地址', '收货方地址'],
  },
  {
    key: 'weight',
    label: '重量(kg)',
    required: true,
    aliases: ['重量(kg)', '重量(KG)', 'weight(kg)', 'weight(KG)', '重量', 'weight', '货物重量'],
  },
  {
    key: 'quantity',
    label: '件数',
  ...
  },
  {
    ...
    label: '温层',
    required: true,
    aliases: ['温层', '温度要求', 'temp zone', '温度', '温区', '温控', 'temperature'],
  },
  {
    key: 'remark',
    label: '备注',
